...
public class AppShortCutUtil {
    ...
    public static boolean setNotificationBadge(int count, Context context) {
        ...
        if (mBuilder == null) {
            mBuilder = new NotificationCompat.Builder(context,"badge");
            ...
            mBuilder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap
                    .ic_launcher));
            mBuilder.setSmallIcon(R.mipmap.ic_launcher);

            mBuilder.setContentTitle("application_angle");
            mBuilder.setOnlyAlertOnce(true);
            mBuilder.setAutoCancel(true);
            mBuilder.setAutoCancel(true);
            mBuilder.setChannelId("badge");
            mBuilder.setNumber(count);
            mBuilder.setBadgeIconType(NotificationCompat.BADGE_ICON_SMALL).build();
...
//            mBuilder.build().flags |= Notification.FLAG_NO_CLEAR;
        ...
        mBuilder.setContentText("you_have" + count + "unread_message");
